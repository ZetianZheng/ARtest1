...
//        }
    ...
    func alertShowEnd(leng: String) {
        let lengStr = "Please face the wall. The distance from you to th wall." + leng + "cm"
...
//            self.reset()
    ...
    func clickInputBtn() {
        ...
        let msgAlertCtr = UIAlertController.init(title:"Input",message:"Please enter the distance to the wall",preferredStyle:.alert)
